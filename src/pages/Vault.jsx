...
} from 'lucide-react'; // 'HandsPraying' ko 'HeartHandshake' se badal diya
...
const Vault = () => {
  ...
  const policies = [
    { id: 1, provider: "Star Health Insurance", policyNo: "SH-99234-A", expiry: "12 Oct 2026", status: "Active" },
    { id: 2, provider: "Ayushman Bharat (ABHA)", idNo: "91-2234-5567", status: "Linked" }
  ];
        ...
        {policies.map((p) => (
          <div key={p.id} className="bg-white p-8 rounded-[2.5rem] border-2 border-blue-50 shadow-md relative">
            ...
            <div className="mt-8 pt-6 border-t border-slate-50 flex justify-between items-center">
              <button className="text-blue-600 font-black text-lg flex items-center gap-2">View <ExternalLink size={20} /></button>
            </div>
          </div>
        ))}
      </div>
